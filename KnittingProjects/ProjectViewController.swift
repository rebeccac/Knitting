...
class ProjectViewController: UIViewController {
    ...
    @IBOutlet var enterNotesLabel: UILabel
    ...
    // when user clicks in notes UITextView, hide "Enter your notes..." label
    func textViewDidBeginEditing(textView: UITextView) {
        enterNotesLabel.hidden = true
    }
...
//        notesTextField.layer.borderWidth = 1.0
        ...
        // if user has entered notes, hide "Enter your notes..." label
        if notesTextField.text.utf16count > 0 {
            enterNotesLabel.hidden = true
        }
    }
